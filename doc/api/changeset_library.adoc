...
The https://github.com/ether/etherpad-lite/blob/develop/ep_etherpad-lite/static/js/Changeset.js[changeset
library]
...
numeric identifiers that reference attributes kept in an https://github.com/ether/etherpad-lite/blob/develop/ep_etherpad-lite/static/js/AttributePool.js[attribute pool].
