...
exports.padeditbar = new class {
  ...
  setEmbedLinks() {
    ...
    if ($('#readonlyinput').is(':checked')) {
      ...
      $('#embedinput')
          .val(`<iframe name="embed_readonly" ep_etherpad-lite="${readonlyLink}${params}" ${props}></iframe>`);
      $('#linkinput').val(readonlyLink);
    } else {
      $('#embedinput')
          .val(`<iframe name="embed_readwrite" ep_etherpad-lite="${padUrl}${params}" ${props}></iframe>`);
