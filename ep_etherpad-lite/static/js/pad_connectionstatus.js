...
const padconnectionstatus = (() => {
  ...
  const self = {
    ...
    disconnected: (msg) => {
      ...
      // message ID is added here then a new div must be added to ep_etherpad-lite/templates/pad.html and the
      // corresponding l10n IDs must be added to the language files in ep_etherpad-lite/locales.
      const knownReasons = [
        'badChangeset',
        'corruptPad',
        'deleted',
