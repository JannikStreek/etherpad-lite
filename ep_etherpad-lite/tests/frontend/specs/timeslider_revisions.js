...
describe('timeslider', function () {
  ...
  it('loads adds a hundred revisions', async function () {
    ...
    $('#iframe-container iframe')
        .attr('ep_etherpad-lite', `${$('#iframe-container iframe').attr('ep_etherpad-lite')}/timeslider`);
  ...
  it('jumps to a revision given in the url', async function () {
    ...
    $('#iframe-container iframe')
        .attr('ep_etherpad-lite', `${$('#iframe-container iframe').attr('ep_etherpad-lite')}/timeslider#0`);
