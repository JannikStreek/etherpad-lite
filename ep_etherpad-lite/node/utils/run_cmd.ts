 ...
 *   - `env.PATH` is prefixed with `ep_etherpad-lite/node_modules/.bin:node_modules/.bin` so that utilities from
...
module.exports = exports = (args: string[], opts:RunCMDOptions = {}) => {
  ...
  opts.env = {
    ...
    [pathVarName]: [
      path.join(settings.root, 'ep_etherpad-lite', 'node_modules', '.bin'),
